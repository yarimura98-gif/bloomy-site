    ...
    <div translate="no" style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", background: "#070d1a", color: "#f1f5f9", minHeight: "100vh", overflowX: "hidden" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 20, marginBottom: 24 }}>
            ...
            <Section delay={0.12}>
              <div style={{ borderRadius: 14, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", padding: "28px 24px" }}>
                <p style={{ margin: "0 0 4px", fontSize: 12, color: "#93c5fd", letterSpacing: 2, textTransform: "uppercase" }}>縦動画・リール編集プラン</p>
                <p style={{ margin: "0 0 20px", fontSize: 13, color: "rgba(241,245,249,0.5)" }}>Instagram / TikTok / YouTube Shorts</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {[["1分以内","¥6,000"],["2分以内","¥8,000"],["3分以内","¥10,000"],["4分〜","¥15,000"]].map(([range, price]) => (
      ...
      <section id="お問い合わせ" style={{ padding: "80px 40px", textAlign: "center", background: "rgba(37,99,235,0.06)", borderTop: "1px solid rgba(37,99,235,0.12)" }}>
        <Section>
          ...
          <a href="mailto:w.k.dsya@gmail.com" style={{ padding: "15px 36px", borderRadius: 8, background: "#2563eb", border: "none", color: "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer", boxShadow: "0 4px 24px rgba(37,99,235,0.45)", textDecoration: "none", display: "inline-block" }}>
            w.k.dsya@gmail.com
          </a>
        </Section>
      </section>
