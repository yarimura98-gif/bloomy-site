...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif", background: "#070d1a", color: "#f1f5f9", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "100px 40px 60px", maxWidth: 1100, margin: "0 auto", gap: 60, flexWrap: "wrap" }}>
        <div style={{ flex: 1, minWidth: 280, animation: "fadeUp 0.9s ease forwards" }}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <button style={{ padding: "13px 28px", borderRadius: 8, background: "#2563eb", border: "none", color: "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer", boxShadow: "0 4px 20px rgba(37,99,235,0.4)" }}>お問い合わせ</button>
            <button style={{ padding: "13px 28px", borderRadius: 8, background: "transparent", border: "1px solid rgba(37,99,235,0.4)", color: "#93c5fd", fontSize: 14, fontWeight: 600, cursor: "pointer" }}>料金を見る</button>
          </div>
        </div>
